...
function display_help() {
    ...
    echo "  (OPTIONAL) MIMIC extension                     Choose the extension to parse, available are 'ed', 'cxr' and 'note'."
    echo
    echo "Options:"
...
"")
    ...
    ;;
*)
    echo "Error: Invalid extension provided. Choose from 'ed', 'cxr' or 'note'."
    display_help
    ;;
esac
